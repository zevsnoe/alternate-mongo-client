package db.client.app.adapter.mongo;

import db.client.app.contract.QueryAdapter;
import db.client.app.adapter.mongo.bean.AdoptedStatement;
import db.client.app.adapter.mongo.converter.DropConverter;
import db.client.app.adapter.mongo.converter.InsertConverter;
import db.client.app.adapter.mongo.converter.SelectConverter;
import db.client.app.adapter.mongo.converter.UpdateConverter;
import db.client.app.adapter.mongo.validator.InvalidSQLException;
import db.client.app.adapter.mongo.validator.MongoSQLAdapterException;
